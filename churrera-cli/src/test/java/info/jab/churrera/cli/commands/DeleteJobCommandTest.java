...
class DeleteJobCommandTest {
    ...
    void testRun_JobWithChildJobs_CascadeDelete() throws BaseXException, QueryException {
        ...
        Job childJob1 = new Job(childJobId1,
            ...
            "test-model",
            "test-repo",
            AgentState.FINISHED, LocalDateTime.now(), LocalDateTime.now(), parentJobId, null, null);
    ...
    void testRun_JobWithNestedChildJobs_RecursiveCascadeDelete() throws BaseXException, QueryException {
        ...
        Job parentJob = new Job(parentJobId,
            ...
            "test-model",
            "test-repo",
            AgentState.FINISHED, LocalDateTime.now(), LocalDateTime.now(), grandparentJobId, null, null);
